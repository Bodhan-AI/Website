...
const VisionMission = () => {
    return (
        <div id="vision-mission" className="w-full bg-[var(--bg-black-900)] text-white py-24 px-6 relative scroll-mt-32">
            ...
            {/* Vision Block */}
            <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-20 md:mb-40 relative z-10">
            ...
            {/* Mission Block */}
            <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-0 md:mb-32 relative z-10">
                <div className="w-full aspect-[4/3] bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl overflow-hidden shadow-2xl border border-white/10 order-2 md:order-1 relative">
                    {/* Mission Image */}
